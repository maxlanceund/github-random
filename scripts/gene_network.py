...
if __name__ == "__main__":
    print("=" * 70)
    print("Gene regulatory network: how much genotype information does phenotype lose?")
    print("=" * 70)
    print()
    ...
    for N in [6, 8, 10, 12]:
        for K in [2, 3]:
            ...
            print(f"N={N:>2}, K={K}: D_f={D_f:.4f}, unique_phenotypes={n_unique}, max_group={max_group}", flush=True)
